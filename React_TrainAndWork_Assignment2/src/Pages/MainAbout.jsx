                ...
                <div className="col-xl-8 col-lg-7">
                  <div className="about-us-brief-desc">
                    <p>
                      ...
                      pick and curate the best in quality and style for you and
                      your home.
                    </p>
                    <p>
                      Why spend days driving from store to store trying to find
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <div className="single-process">
                    ...
                    <p className="description">
                      ...
                      décor for every room, plus a vast assortment of
                ...
                <div className="col-lg-3 col-md-6 col-sm-6">
                  <div className="single-process">
                    ...
                    <p className="description">
                      ...
                      Match Promise ensure you are always happy with your
                      purchase.
                    </p>
                  </div>
                </div>
                      ...
                      <div className="single-team-member">
                        ...
                        <div className="single-team-member__content">
                          ...
                          <p className="short-desc">
                            ...
                            friendly, professional and detail-oriented approach
                            for every customer shopping with his team.
                          </p>
                          <ul className="social-profiles">
                            <li>
                              <a href="#">
                      ...
                      <div className="single-team-member">
                        ...
                        <div className="single-team-member__content">
                          ...
                          <p className="short-desc">
                            ...
                            life, from a sanctuary for a good night's sleep to a
                            welcoming home to share with family and friends.
